...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( oLanguage )
	{
		...
		if ( !oLanguage.sEmptyTable && zeroRecords &&
			oDefaults.sEmptyTable === "Нет информации" )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Отображено с _START_ по _END_ из _TOTAL_ запросов",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(Отобрано из _MAX_ запросов)",
			 ...
			 *    } );
			 */
			"sZeroRecords": "По заданому критерию ничего не найдено"
		},
